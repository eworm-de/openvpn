...
net__iface_mtu_set(int mtu)
{
    ...
    return net_iface_mtu_set(iface, mtu);
}
...
net__addr_v4_add(const char *addr_str, int prefixlen, const char *brd_str)
{
    ...
    return net_addr_v4_add(iface, &addr, prefixlen, &brd);
}
...
net__addr_v6_add(const char *addr_str, int prefixlen)
{
    ...
    return net_addr_v6_add(iface, &addr, prefixlen);
}
...
net__route_v4_add(const char *dst_str, int prefixlen, int metric)
{
    ...
    return net_route_v4_add(&dst, prefixlen, NULL, iface, 0, metric);
                     ...
                     int metric)
{
    ...
    return net_route_v4_add(&dst, prefixlen, &gw, iface, 0, metric);
}
...
net__route_v6_add(const char *dst_str, int prefixlen, int metric)
{
    ...
    return net_route_v6_add(&dst, prefixlen, NULL, iface, 0, metric);
                     ...
                     int metric)
{
    ...
    return net_route_v6_add(&dst, prefixlen, &gw, iface, 0, metric);
}
